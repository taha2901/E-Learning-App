...
class _CreateEditCourseScreenState extends State<CreateEditCourseScreen> {
  ...
  Future<void> _save() async {
    ...
    // BlocListener في الـ parent (AdminCoursesScreen) هيعرض الـ snack
    // هنا بس نرجع لو نجح
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AdminCoursesCubit, AdminCoursesState>(
      builder: (context, state) {
        final isSaving = state is AdminCoursesActionLoading;
          ...
          body: Form(
            ...
            child: ListView(
              ...
              children: [
                ...
                _SaveButton(isEdit: _isEdit, saving: isSaving, onSave: _save),
